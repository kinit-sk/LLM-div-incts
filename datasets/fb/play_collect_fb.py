...
get_subsampled.to_csv('fb/play/'+str(NO_TRY)+'/seeds.csv', index=False)
...
fb_0.drop_duplicates().to_csv('fb/play/'+str(NO_TRY)+'/fb_0_seeds.csv', index=False)

dct_responses = collect_samples(dct_final_prompts)

fb_0 = filter_responses(dct_responses)
fb_0.drop_duplicates().to_csv('fb/play/'+str(NO_TRY)+'/fb_1_seeds.csv', index=False)

fb_0 = pd.read_csv('fb/play/'+str(NO_TRY)+'/fb_0_seeds.csv')
...
fb_0 = filter_responses(dct_responses)
fb_0.drop_duplicates().to_csv('fb/play/'+str(NO_TRY)+'/fb_1_taboo.csv', index=False)

fb_0 = pd.read_csv('fb/play/'+str(NO_TRY)+'/fb_0_seeds.csv').drop_duplicates()
fb_0['text'] = fb_0['text'].astype("string")
dct_phrases = fb_0.groupby('label')['seed'].apply(set).to_dict()
...
fb_0 = filter_responses(dct_responses)
fb_0.drop_duplicates().to_csv('fb/play/'+str(NO_TRY)+'/fb_1_chaining.csv', index=False)
...
fb_0 = filter_responses(dct_responses)
fb_0.drop_duplicates().to_csv('fb/play/'+str(NO_TRY)+'/fb_1_hints.csv', index=False)
