...
for NO_TRY in range(0,5):
    ...
    fb_0.drop_duplicates().to_csv('yelp/mistral/'+str(NO_TRY)+'/fb_1_taboo_ablt.csv', index=False)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('yelp/mistral/'+str(NO_TRY)+'/fb_1_chaining_ablt.csv', index=False)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('yelp/mistral/'+str(NO_TRY)+'/fb_1_hints_ablt.csv', index=False)
