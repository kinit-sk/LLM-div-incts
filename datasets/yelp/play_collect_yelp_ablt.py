...
for NO_TRY in range(0,5):
    fb_0 = pd.read_csv('yelp/play/'+str(NO_TRY)+'/fb_0_seeds.csv')
    ...
    fb_0.drop_duplicates().to_csv('yelp/play/'+str(NO_TRY)+'/fb_1_taboo_ablt.csv', index=False)

    fb_0 = pd.read_csv('yelp/play/'+str(NO_TRY)+'/fb_0_seeds.csv').drop_duplicates()
    fb_0['text'] = fb_0['text'].astype("string")
    dct_phrases = fb_0.groupby('label')['seed'].apply(set).to_dict()
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('yelp/play/'+str(NO_TRY)+'/fb_1_chaining_ablt.csv', index=False)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('yelp/play/'+str(NO_TRY)+'/fb_1_hints_ablt.csv', index=False)
