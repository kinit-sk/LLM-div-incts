...
for NO_TRY in range(3,5):
    ...
    get_subsampled.to_csv('20news/llama/'+str(NO_TRY)+'/seeds.csv', index=False)
    dct_phrases = {}
    ...
    fb_0.drop_duplicates().to_csv('20news/llama/'+str(NO_TRY)+'/fb_0_seeds.csv', index=False)

    dct_responses = collect_samples(dct_final_prompts)

    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('20news/llama/'+str(NO_TRY)+'/fb_1_seeds.csv', index=False)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('20news/llama/'+str(NO_TRY)+'/fb_1_taboo.csv', index=False)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('20news/llama/'+str(NO_TRY)+'/fb_1_chaining.csv', index=False)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('20news/llama/'+str(NO_TRY)+'/fb_1_hints.csv', index=False)
