...
for NO_TRY in range(0,5):
    ...
    dct_taboo = get_taboo_w_for_df_no_ner(fb_0, 3, dct_phrases, True)
    ...
    fb_0.drop_duplicates().to_csv('atis/llama/'+str(NO_TRY)+'/fb_1_taboo_ablt.csv', index=False)
    ...
    dct_phrases = get_seed_sentences_per_labels(df_outliers, dct_phrases, True)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('atis/llama/'+str(NO_TRY)+'/fb_1_chaining_ablt.csv', index=False)
    ...
    dct_hints_per_sample = get_hint_sentences_per_labels(df_merged, 3, dct_phrases, True)
    ...
    fb_0 = filter_responses(dct_responses)
    fb_0.drop_duplicates().to_csv('atis/llama/'+str(NO_TRY)+'/fb_1_hints_ablt.csv', index=False)
